 ...
 * template literal.
 */
export declare function isOnEnclosingTemplateDelimiterLine(node: TSESTree.Node): boolean;
 ...
 */
export declare function collectReferences(scope: Scope.Scope): Scope.Reference[];
...
export declare function hasStringFirstArgument(node: estree.CallExpression): boolean;
