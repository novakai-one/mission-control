    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          {error && (
            <div style={{
              ...
              border: '1px solid #c97a7a44', borderRadius: '6px',
              fontSize: '0.7rem', color: '#c97a7a',
            }}>
              {error}
            </div>
          )}
          ...
          >
            ...
            />
            {geminiKey && (
              <span style={{ fontSize: '0.55rem', color: '#7ac98f', marginTop: '0.3rem', display: 'flex', alignItems: 'center', gap: '0.2rem' }}>
        ...
        <div style={{
          ...
          <button onClick={onClose} style={{ ...btnStyle, padding: '0.5rem 1rem' }}>
            Cancel
          </button>
          <button
            onClick={handleSave}
            ...
            style={{
              ...
              backgroundColor: 'var(--status-running)', color: '#7a9ec9',
